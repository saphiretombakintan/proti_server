			...
			<div class="m-grid__item m-grid__item--fluid m-wrapper">
				...
				<div class="m-subheader ">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h3 class="m-subheader__title m-subheader__title--separator">DATA SP3K</h3>
							<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
								...
								<li class="m-nav__item">
									<a href="" class="m-nav__link">
										<span class="m-nav__link-text">Sp3k</span>
									</a>
								</li>
							</ul>
						</div>
        							...
        							<div class="modal-content">
        								<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ route('akad.post') }}">
        									...
        									<div class="modal-body">
        										...
        										<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">KPRS</label>
        											<input type="text" class="form-control m-input" name="kprs" placeholder="Nama KPRS Bank">
        										</div>
														<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">Notaris Developer</label>
        											<input type="text" class="form-control m-input" name="notaris" placeholder="Nama Notaris">
        										</div>
														<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">No PH</label>
        											<input type="text" class="form-control m-input" name="ph" placeholder="no PH jika ada isi NONPH jika tidak ada PH">
        										</div>
                            <div class="form-group m-form__group">
