			...
			<div class="m-grid__item m-grid__item--fluid m-wrapper">
				...
				<div class="m-subheader ">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h3 class="m-subheader__title m-subheader__title--separator">DATA BERKAS</h3>
							<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
								...
								<li class="m-nav__item">
									<a href="" class="m-nav__link">
										<span class="m-nav__link-text">Berkas</span>
									</a>
								</li>
							</ul>
						</div>
                  ...
                  <div class="modal fade" id="m_modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        						<div class="modal-dialog modal-lg" role="document">
        							<div class="modal-content">
        								<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ route('sp3k.post') }}">
        									{{ csrf_field() }}
        									...
        									<div class="modal-body">
        										<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">Tanggal SP3K</label>
        										...
        										<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">Plafon KPR</label>
        											<input type="text" class="form-control m-input" name="plafond" placeholder="Plafon KPR">
        										</div>
														<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">Biaya KPR</label>
        											<input type="text" class="form-control m-input" name="biaya" placeholder="Plafon KPR">
        										</div>
														<div class="form-group m-form__group">
        											<label for="exampleInputEmail1">NO SP3K</label>
        											<input type="text" class="form-control m-input" name="nosp3k" placeholder="Plafon KPR">
        										</div>
                            <div class="form-group m-form__group">
